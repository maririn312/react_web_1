...
export const BidDialog = ({ isOpen, setIsOpen }: BidDialogProps) => {
					...
					<div className="grid grid-cols-2 gap-3">
						<div className="form-control">
							<label className="label">
								<span>{t("label.bidPreBidAmount")}</span>
							</label>
							<BxInput
								id='currentDeposit'
								name='currentDeposit'
						...
						<div className="form-control">
							<label className="label">
								<span>{t("label.bidMaximumAllowed")}</span>
							</label>
							<BxInput 
								id='addingDeposit'
								name='addingDeposit'
						...
						<div className="col-span-2 form-control">
							<label className="label">
								<span>{t("label.bidAmountPlus")}</span>
							</label>
							<BxInput 
								id='addingDeposit'
								name='addingDeposit'
