...
export default class ErrorManager {
  ...
  static handleRequestError = (ex:any) => {
    if(ex instanceof BadResponseError) {
      ...
      switch(ex.code) {
        case "ECONNABORTED": return trans.error.timeout;
        case "ETIMEDOUT": return trans.error.timeout;
        case "ERR_CANCELED": return trans.error.network;
        case "ERR_NETWORK": return trans.error.network;
      }
      return ex.message;
